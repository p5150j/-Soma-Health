...
export type RecursivePartialNull<T> = MovedRecursivePartialNull<T>
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        async AnalyzeHealthRecord(
        patient_json: string,
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.HealthAnalysis> {
          try {
          ...
          const __stream__ = this.stream.AnalyzeHealthRecord(
          patient_json,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.HealthAnalysis
            } catch (error) {
            ...
            patient_json: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.HealthAnalysis, types.HealthAnalysis>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for AnalyzeHealthRecord", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.HealthAnalysis, types.HealthAnalysis>(
                  __raw__,
                  (a): partial_types.HealthAnalysis => a,
                  (a): types.HealthAnalysis => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
